...
def main(input_dir, stage_a_dir, out_dir):
    ...
    result = {
        "version": "NABU_V8_3_CREILOV_SEALED_FINAL_V1",
        "status": (
        ...
        "interpretation_boundary": (
            "One-shot sealed computational candidate-selection test on "
            "CreiLOV 4-5 mutation variants using only <=3 mutation labels "
            "during Stage A. No architecture or threshold changes are "
            "permitted after this reveal."
        ),
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--out",
        default="nabu_v8_3_creilov_final",
    )
